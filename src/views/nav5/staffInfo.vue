<template>
    <section>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
            ...
            <el-table-column prop="jobNumber" label="工号" width="120" sortable>
            </el-table-column>
            <el-table-column prop="building" label="楼号" width="100">
            </el-table-column>
            <el-table-column prop="doorNumber" label="门牌号" width="100">
            </el-table-column>
            <el-table-column prop="academy" label="院系/部门" width="120" sortable>
            </el-table-column>
            <el-table-column prop="houseType" label="房屋类型" width="120" sortable>
            </el-table-column>
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="门牌号">
                    <el-input v-model="addForm.doorNumber" ></el-input>
                </el-form-item>
                <el-form-item label="院系/部门">
